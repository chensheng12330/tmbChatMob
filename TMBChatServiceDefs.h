/*!
 @header TMBChatServiceDefs.h
 @abstract ChatManager相关宏定义
 @author Sherwin.Chen By Temobi Inc.
 @version 1.00 2014/01/01 Creation (1.00)
 */

#ifndef EasTMBobClientSDK_TMBChatServiceDefs_h
#define EasTMBobClientSDK_TMBChatServiceDefs_h

#define TMB_DEPRECATED_IOS(_easemobIntro, _easemobDep, ...) __attribute__((deprecated("")))
...
/*!
 ...
 @constant eMessageBodyType_ShareDoc 共享文档类型
 */
typedef enum {
...
}TMBPushNotificationDisplayStyle;
 ...
 */
typedef enum{
    eVideoRoomMsg_None =0,     //未识别的消息类型
    eVideoRoomMsg_Invite,      //邀请音/视频会议指令
    eVideoRoomMsg_Terminate,   //会议结束通知
}TMBVideoRoomMsgType;
