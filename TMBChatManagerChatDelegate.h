/*!
 @header TMBChatManagerChatDelegate.h
...
/*!
 ...
 @discussion
 */
@protocol TMBChatManagerChatDelegate <TMBChatManagerDelegateBase>
...
/*!
 ...
 @result
 */
- (void)willSendMessage:(TMBMessage *)message
                 error:(EMError   *)error;
...
/*!
 ...
 @result
 */
- (void)didSendMessage:(TMBMessage *)message
                error:(EMError   *)error;
...
/*!
 ...
 下载完所有附件后, 回调didMessageAttachmentsStatusChanged:error:会被触发
 */
- (void)didReceiveCmdMessage:(TMBMessage *)cmdMessage;

/*!
 @method
 @brief 下载消息文件时，失败或成功的回调信息
 @discussion     接收到此回调时，可动态的更新message对应UI.
 @param message  下载完成的消息对象
 @param error    若附件下载成功, error为nil, 若下载失败, 则会返回相应的error信息
 @result
*/
- (void)didMessageofFileDownloadStatus:(TMBMessage *)message error:(EMError *)error;
...
- (void)didFetchingMessageAttachments:(TMBMessage *)message
...
- (void)didMessageAttachmentsStatusChanged:(TMBMessage *)message error:(EMError   *)error;
...
//!
 ...
 @result
 ///
- (void)didReceiveHasReadResponse:(TMBReceipt *)resp;
...
- (void)didReceiveHasDeliveredResponse:(TMBReceipt *)resp;
...
/*!
 @method
 @brief 未读消息数改变时的回调
 @discussion 当TMBConversation对象的enableUnreadMessagesCountEvent为YES时,会触发此回调
 @result
 */
- (void)didUnreadMessagesCountChanged:(NSString*) chatter unreadMsgCount:(NSInteger) unreadMsgCount;
...
/*!
 ...
 @discussion
 @param offlinTMBessages 接收到的离线列表
 @result
 */
