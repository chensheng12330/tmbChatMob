...
/*!
 ...
 @result 会话对象
 */
- (TMBConversation *)conversationForChatter:(NSString *)chatter isGroup:(BOOL)isGroup;
...
/*!
 ...
 @result 保存成功或失败
 */
- (BOOL)insertConversationToDB:(TMBConversation *)conversation
...
/*!
 ...
 @result 是否成功执行
 */
- (BOOL)removeConversationByChatter:(NSString *)chatter deleteMessages:(BOOL)aDeleteMessages  isGroup:(BOOL)isGroup;
...
// */
//- (NSUInteger)unreadConversationsCount TMB_DEPRECATED_IOS(2_0_0, 2_0_8, "不再提供该属性");
...
// */
//- (BOOL)saveMessage:(EMMessage *)message TMB_DEPRECATED_IOS(2_0_6, 2_1_1, "Use - insertMessageToDB:");
//
...
//          append2Chat:(BOOL)append2Chat TMB_DEPRECATED_IOS(2_0_6, 2_1_1, "Use - insertMessageToDB:append2Chat:");
//
//- (BOOL)insertMessageToDB:(EMMessage *)message
//              append2Chat:(BOOL)append2Chat;
//
...
// @return 成功保存的聊天消息条数
// */
//- (NSInteger)saveMessages:(NSArray *)messages TMB_DEPRECATED_IOS(2_0_6, 2_1_1, "Use - insertMessagesToDB:");
//
...
//add by yingzhuo 2015.08.06
-(void)deleteMessages:(NSString *)jidStr;
