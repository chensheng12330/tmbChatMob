...
/*!
 ...
 @constant eGroupStyle_PrivatTMBTMBberCanInvite 私有群组，owner和mTMBber权限的人可以邀请人加入
...
/*!
 ...
 @brief 群组参数设置类
 */
@interface TMBGroupStyleSetting : NSObject

/*!
 @property
 @brief 群组的类型
 */
@property (nonatomic) TMBGroupStyle groupStyle;
