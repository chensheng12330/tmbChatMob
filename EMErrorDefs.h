/*!
 ...
 @abstract SDK 错误定义
 @author Sherwin.chen Inc.
 @version 1.00 2014/01/01 Creation (1.00)
 */

#ifndef TemobiMobClientSDK_EMErrorDefs_h
#define TemobiMobClientSDK_EMErrorDefs_h

/*!
 @enum
 @brief TemobiMob SDK 错误定义
 @discussion
...
typedef enum : NSUInteger {
    ...
    EMErrorFuctionParametersError,               //调用函数传入的参数错误.
} EMErrorType;
