...
//! 查询本地数据库中的存在的群组
-(TMBGroup*) findInDBWithGroupID:(NSString*) groupID;
...
- (void)asyncCreateGroupWithSubject:(NSString *)subject
                        description:(NSString *)description
                           invitees:(NSArray *)invitees
              initialWelcomeMessage:(NSString *)welcomeMessage
                       styleSetting:(TMBGroupStyleSetting *)styleSetting;
 ...
 */
- (void)asyncJoinGroup:(NSString *)groupId
              nickname:(NSString *)nickname;
...
//                                  invitees:(NSArray *)invitees
//                     initialWelcomeMessage:(NSString *)welcomeMessage
//                                     error:(EMError **)pError TMB_DEPRECATED_IOS(2_0_0, 2_0_2, "Use -createGroupWithSubject:description:invitees:initialWelcomeMessage:styleSetting:error:");
//
///*!
// @method
// @brief 异步方法, 创建一个私有群组
...
//                               description:(NSString *)description
//                                  invitees:(NSArray *)invitees
//                     initialWelcomeMessage:(NSString *)welcomeMessage TMB_DEPRECATED_IOS(2_0_0, 2_0_2, "Use -asyncCreateGroupWithSubject:description:invitees:initialWelcomeMessage:styleSetting:");
//
///*!
// @method
// @brief 异步方法, 创建一个私有群组
...
//                                completion:(void (^)(EMGroup *group,
//                                                     EMError *error))completion
//                                   onQueue:(dispatch_queue_t)aQueue TMB_DEPRECATED_IOS(2_0_0, 2_0_2, "Use -asyncCreateGroupWithSubject:description:invitees:initialWelcomeMessage:styleSetting:completion:onQueue:");
//
 ...
 */    //modify by yingzhuo 2015.08.07
- (void)changeGroupSubject:(NSString *)subject
                  forGroup:(NSString *)groupId;
/*!
 @method
 @brief 异步方法, 更改群组主题
...
/*!
 ...
 forGroup:(NSString *)groupId
 error:(EMError **)pError TMB_DEPRECATED_IOS(2_0_3, 2_0_9, "Delete");
 */
/*!
 @method
 @brief 异步方法, 更改群组密码
 ...
 forGroup:(NSString *)groupId TMB_DEPRECATED_IOS(2_0_3, 2_0_9, "Delete");
 */
/*!
 @method
 @brief 异步方法, 更改群组密码
 ...
 onQueue:(dispatch_queue_t)aQueue TMB_DEPRECATED_IOS(2_0_3, 2_0_9, "Delete");
 */
...
/*!
 ...
 - (EMGroup *)changeAffiliation:(TMBGroupMemberRole)newAffiliation
...
/*!
 ...
 - (void)asyncChangeAffiliation:(TMBGroupMemberRole)newAffiliation
 forOccupants:(NSArray *)occupants
 inGroup:(NSString *)groupId TMB_DEPRECATED_IOS(2_0_3, 2_0_9, "Delete");
 */
/*!
 @method
 @brief 异步方法, 更改成员的权限级别
...
/*!
 ...
 @param reason   拒绝理由
 */
- (void)asyncRejectInvitationForGroup:(NSString *)groupId
                            toInviter:(NSString *)username
                               reason:(NSString *)reason;
...
/*!
 ...
 - (NSArray *)fetchAllPrivateGroupsWithError:(EMError **)pError TMB_DEPRECATED_IOS(2_0_0, 2_0_2, "Use -fetchMyGroupsListWithError:");
 */
/*!
 @method
 @brief 异步方法, 获取所有私有群组
 ...
 - (void)asyncFetchAllPrivateGroups TMB_DEPRECATED_IOS(2_0_0, 2_0_2, "Use -asyncMyGroupsList");
 */
/*!
 @method
 @brief 异步方法, 获取所有私有群组
 ...
 EMError *error))completion
 onQueue:(dispatch_queue_t)aQueue TMB_DEPRECATED_IOS(2_0_0, 2_0_2, "Use -asyncMyGroupsListWithCompletion:onQueue:");
 */
